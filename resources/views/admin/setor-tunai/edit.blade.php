                ...
                <form action="{{ url('/admin/setor-tunai/' . $data['id']) }}" method="post">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="input-form container pb-2 m-3">
                            ...
                            <label class="pt-1">Nama Penyetor</label>
                            <div class="input-group">
                                <input type="text" name="name" id="name" value="{{ $data['name'] }}" class="form-control input m-2 rounded-3" placeholder="Nama Penyetor">
                            </div>
